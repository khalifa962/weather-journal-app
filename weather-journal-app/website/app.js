...
generateBtn.addEventListener("click", async() => {
        ...
        getTemprature(apiURL, zipCode, APiKey)
            .then(result => {
                return getWeatherData(temprature, feelings)
...
async function getTemprature(apiURL, zipCode, APiKey) {
    const resp = await fetch(apiURL + zipCode + ',us' + '&appid=' + APiKey);
...
async function updateUI() {
    ...
    document.querySelector("#temp").innerHTML = projectData.temperature;
